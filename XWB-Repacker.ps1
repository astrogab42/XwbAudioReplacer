...
$CustomFilesSizeError = "CustomFilesError-Size-tmp.txt" # Temporary files to store errors
$CustomFilesNameError = "CustomFilesError-Name-tmp.txt"
$CustomFilesDateError = "CustomFilesError-Date-tmp.txt"
...
$DubbedFilesSizeErrorFinal = "CustomFilesError-Size.txt"
$DubbedFilesNameErrorFinal = "CustomFilesError-Name.txt"
$DubbedFilesDateErrorFinal = "CustomFilesError-Date.txt"
